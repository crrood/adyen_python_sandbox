...
class ServerUtils():
	...
	def load_config(self, config_file):
		...
		loaded_config["ws_user"] = credentials["wsUser"]
		loaded_config["ws_password"] = credentials["wsPass"]
		loaded_config["api_key"] = credentials["apiKey"]
		loaded_config["hmac_key"] = credentials["hmacKey"]
		loaded_config["skin_code"] = credentials["skinCode"]
